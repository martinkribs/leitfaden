...
\glsaddall
% Trenner ändern - Bindestrich zwischen Abkürzung und Erklärung
...
% Seitenstil für plain Seiten
\fancypagestyle{plain}{%
  \fancyhf{} % Alle Kopf- und Fußzeilenfelder löschen
  \lhead{\fontsize{9}{13.5}\selectfont\nouppercase{\leftmark}} % Kapitelüberschrift oben links
  \rhead{\fontsize{9}{13.5}\selectfont\thepage} % Seitenzahl oben rechts
}
...
% Listings für Code
\input{zusatz/listing-definitions}
