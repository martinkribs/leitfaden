...
Falls Sie möchten, können Sie Ihrer Arbeit einen spezifischen Hinweis voranstellen, zum Beispiel in einer Vorbemerkung oder in einer Fußnote, weil Sie damit möglichen Fehldeutungen vorbeugen können.\footnote{In dieser Arbeit wird das generische Maskulinum verwendet, wenn im Mittelpunkt der Aussagen keine spezifischen Personen stehen, sondern die Funktion, die Personen ausüben. Sämtliche biologischen Geschlechter und subjektiv empfundenen Zuordnungen sind damit gleichermaßen gemeint.} Zwingend notwendig ist ein solcher Hinweis nicht.

Falls Sie in Ihrem Text gendern möchten, finden Sie dazu Hinweise in Anhang \ref{app:gendern}.