...
\begin{minipage}{0.48\textwidth}
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{bilder/Schmutztitel.png}}
\end{minipage}
\hfill
\begin{minipage}{0.48\textwidth}
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{bilder/Haupttitel.png}}
\end{minipage}
...
\begin{table}[H]
    \centering
    \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}p{3cm}|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}p{2.5cm}}
    \textbf{Fachbereich} & \textbf{Studiengang} & \textbf{Einbandfarbe} \\
    \specialrule{1.5pt}{0pt}{0pt}
    \multirow{5}{*}{Ingenieurwesen} & Elektrotechnik (\gl{beng}) & Schwarz \\
    \cline{2-3}
    & Informatik (\gl{bsc}) & Hellgrün \\
    \cline{2-3}
    & Maschinenbau (\gl{beng}), alle Fachrichtungen & Dunkelblau \\
    \cline{2-3}
    & Prozesstechnik (\gl{bsc}) & Hellgrün \\
    \cline{2-3}
    & Wirtschaftsingenieurwesen (\gl{beng}) & Dunkelgrün \\
    \cline{2-3}
    & Alle Masterstudiengänge & Dunkelblau \\
    \specialrule{1.5pt}{0pt}{0pt}
    \multirow{17}{*}{\begin{tabular}[c]{@{}l@{}}Wirtschaft,\\ Psychologie \&\\ Recht\end{tabular}} & Betriebswirtschaftslehre (\gl{ba}) & Gelb \\
    \cline{2-3}
    & Compliance \& Corporate Security (\gl{llm}) & Rot \\
    \cline{2-3}
    & Digital Transformation Management (\gl{ma}) & Gelb \\
    \cline{2-3}
    & Entrepreneurship (\gl{ma}) & Gelb \\
    \cline{2-3}
    & General Management (\gl{ma}) & Gelb \\
    \cline{2-3}
    & International Business Management (\gl{ma}) & Gelb \\
    \cline{2-3}
    & \gl{mba} International Business (\gl{mba}) & Gelb \\
    \cline{2-3}
    & Nachhaltigkeitsmanagement (\gl{ba}) & Gelb \\
    \cline{2-3}
    & Psychologie (\gl{bsc}) & Orange \\
    \cline{2-3}
    & Steuerrecht (\gl{llm}) & Rot \\
    \cline{2-3}
    & Unternehmensmanagement (\gl{ba}) & Gelb \\
    \cline{2-3}
    & Werteorientierte Unternehmensführung (M.Sc.) & Gelb \\
    \cline{2-3}
    & Wirtschaftsinformatik (\gl{bsc}) & Grau \\
    \cline{2-3}
    & Wirtschaftsinformatik (M.Sc.) & Grau \\
    \cline{2-3}
    & Wirtschaftspsychologie (\gl{bsc}) & Orange \\
    \cline{2-3}
    & Wirtschaftspsychologie (M.Sc.) & Orange \\
    \cline{2-3}
    & Wirtschaftsrecht (\gl{llb}) & Rot \\
    \specialrule{1.5pt}{0pt}{0pt}
    \multirow{6}{*}{\begin{tabular}[c]{@{}l@{}}Medien,\\ Marketing \&\\ Innovation\end{tabular}} & Digital Business Management (\gl{ma}) & Weiß \\
    \cline{2-3}
    & International Marketing \& Media Management (\gl{ma}) & Weiß \\
    \cline{2-3}
    & Media \& Marketing Management (\gl{ba}) & Weiß \\
    \cline{2-3}
    & Mediendesign (\gl{ba}) & Braun oder eigene \\
    \cline{2-3}
    & User Experience Design (\gl{ma}) & Weiß oder eigene \\
    \specialrule{1.5pt}{0pt}{0pt}
    \multirow{5}{*}{\begin{tabular}[c]{@{}l@{}}Medizinökonomie\\ \&\\ Gesundheit\end{tabular}} & Erweiterte Pflegepraxis (\gl{bsc}) & Magenta \\
    \cline{2-3}
    & Gesundheitsökonomie (M.Sc.) & Magenta \\
    \cline{2-3}
    & \begin{tabular}[c]{@{}l@{}}Medizinökonomie \&\\ Digitales Management (\gl{bsc})\\ (ehem. Medizinökonomie)\end{tabular} & Magenta \\
    \cline{2-3}
    & Molekulare Biomedizin (\gl{bsc}) & Magenta \\
    \cline{2-3}
    & Physiotherapie (\gl{bsc}) & Magenta \\
    \hline
    \end{tabularx}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{bilder/Libelle-Sichtfeld}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{bilder/Verzeichnisse}
